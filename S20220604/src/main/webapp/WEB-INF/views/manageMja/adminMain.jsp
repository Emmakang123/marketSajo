...
<div class="container">
	<div class="row">	
		...
		<div class="col-md-10" id="main">
						...
						<div class="card bg-gradient-danger card-img-holder text-black">
							<div class="card-body">
								<i class="fa-solid fa-user"></i>
									<h2 class="mb-5 number"> ${memNum }</h2>
									<h4 class="font-weight-normal mb-3"> 총 회원 수  </h4>
							</div>
						</div>
					</div>
					<div class="col-md-4 stretch-card grid-margin">
						<div class="card bg-gradient-danger card-img-holder text-black">
							<div class="card-body">
								<i class="fa-solid fa-store"></i>
									<h2 class="mb-5 number">  ${sellerNum }</h2>
									<h4 class="font-weight-normal mb-3">  판매자 요청 대기  </h4>
							</div>
						</div>
					</div>
					<div class="col-md-4 stretch-card grid-margin">
						<div class="card bg-gradient-danger card-img-holder text-black">
							<div class="card-body">
								<i class="fa-solid fa-person-arrow-up-from-line"></i>
									<h2 class="mb-5 number">  ${newMemNum }</h2>
									<h4 class="font-weight-normal mb-3">  신규회원</h4>
							</div>
						</div>
				    </div>
		 		</div>
			...
			<div id="new">신규회원</div>
			<div id= "newMember" >
				<div id="date">[기간] ${minusdate } ~ ${sysdate }</div>
