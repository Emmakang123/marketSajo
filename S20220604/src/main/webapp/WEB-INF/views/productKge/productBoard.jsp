...
<body>
	...
	<div class="pageNum">
		<c:if test="${pg.startPage > pg.pageBlock }">
			<a href="productBoard?currentPage=${pg.startPage-pg.pageBlock}&pro_type1=${product.pro_type1}&pro_type2=${product.pro_type2}">[이전]</a>
		</c:if>
		<c:forEach var="i" begin="${pg.startPage}" end="${pg.endPage}">
			<a href="productBoard?currentPage=${i}&pro_type1=${product.pro_type1}&pro_type2=${product.pro_type2}">[${i}] </a>
		</c:forEach>
		<c:if test="${pg.endPage < pg.totalPage }">
			<a href="productBoard?currentPage=${pg.startPage+pg.pageBlock}&pro_type1=${product.pro_type1}&pro_type2=${product.pro_type2}">[다음]</a>
		</c:if>
	</div>
