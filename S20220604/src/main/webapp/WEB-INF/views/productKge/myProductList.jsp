	...
	<section>
		...
		<h1 class=myProductList><b>나의 상품등록 리스트</b></h1>
			...
			<table id="mylistTable">
				<tr>
					<th id="listHead"><b>상품번호&nbsp;&nbsp;</b></th><th id="listHead"><b>상품판매글제목&nbsp;&nbsp;</b></th><th id="listHead"><b>작성일&nbsp;&nbsp;</b></th><th id="listHead"><b>재고&nbsp;&nbsp;</b></th><th id="listHead"><b>판매량&nbsp;&nbsp;</b></th><th id="listHead"><b>기능</b></th> 
				</tr>
