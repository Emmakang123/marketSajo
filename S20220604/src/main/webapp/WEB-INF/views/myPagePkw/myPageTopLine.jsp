...
<body>
	<myPageTopLine>
		<div class="myPageTopLine_userMode">
			<button onclick = "location.href = '${pageContext.request.contextPath}/shopperMyPage' "  id="userMode_button">쇼퍼</button>
			<button onclick = "location.href = '${pageContext.request.contextPath}/makerMyPage' "    id="userMode_button">메이커</button>
		</div>
