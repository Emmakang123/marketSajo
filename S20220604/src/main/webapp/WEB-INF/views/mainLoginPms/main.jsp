...
<div id = coupon_evt>
    ...
    <button onclick="location.href='chatWithConsumer'">리뷰유저 문의하기</button>
			...
			<c:forEach var="product_bestTop4list" items="${product_bestTop4list }">
				<div class="col-lg-3 col-md-6">
					<div class="card" style="width: 18rem;">
					  <img alt= "상품메인이미지" src="/upload/${product_bestTop4list.pro_photo}" class="card-img-top" alt="...">
					  <div class="card-body">
	...
	<div class="product_newTop4list">
		<div class="row"> 
			<c:forEach var="product_newTop4list" items="${product_newTop4list }">
				<div class="col-lg-3 col-md-6">
					<div class="card" style="width: 18rem;">
					  <img alt= "상품메인이미지" src="/upload/${product_newTop4list.pro_photo}" class="card-img-top" alt="...">
					  <div class="card-body">
