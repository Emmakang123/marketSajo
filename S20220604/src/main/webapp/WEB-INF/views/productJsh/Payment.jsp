	...
	<section>
		...
		<table>
			...
			<table id="pay_product">
				...
				<tr>
					<td><img src="${pageContext.request.contextPath}/uplaod/${productInfo.pro_photo}" class="img_size"></img></td>
					<td><input type="text" class="pro_title" value="${productInfo.pro_title}" readonly="readonly"></td>
					<td><input type="text" value="${productQuantity[status.index]}" readonly="readonly"></td>
					<td><input type="text" value="${productQuantity[status.index] * productInfo.pro_price}" readonly="readonly"></td>
				</tr>
				</c:forEach>  
			</table>			
